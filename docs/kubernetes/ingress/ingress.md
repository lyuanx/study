...
[traefik ingress](https://feisky.gitbooks.io/kubernetes/practice/service-discovery-lb/traefik-ingress-installation.html)提供了一个traefik ingress的实践案例
[kubernetes/ingress](https://github.com/kubernetes/ingress/tree/master)提供了更多的Ingress示例

参考[官网文档](https://www.kubernetes.org.cn/ingress)
